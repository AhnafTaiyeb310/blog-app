    ...
    <aside className="hidden xl:flex w-[320px] flex-col gap-8">
      ...
      <section>
        <div className="mb-4 flex items-center justify-between">
          ...
          <Button variant="link" className="h-auto p-0 text-xs font-semibold text-purple-600">See all</Button>
        </div>
        <div className="space-y-4">
          {ARTICLES.slice(0, 3).map((article) => (
            <div key={article.id} className="group flex gap-4 items-start cursor-pointer">
