...
export function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 hidden h-screen w-[260px] flex-col border-r bg-white p-6 lg:flex">
      {/* User Profile Section */}
      <div className="mb-8 flex items-center gap-3">
        <Avatar className="h-12 w-12 bg-gradient-to-br from-purple-500 to-indigo-600 p-0.5">
      ...
      <nav className="flex-1 space-y-2">
        ...
        {NAV_ITEMS.map((item) => (
          ...
          >
            <item.icon className={cn("h-5 w-5", item.active ? "text-purple-600" : "text-slate-400")} />
      ...
      {/* Upgrade Card */}
      <Card className="mt-auto border-none bg-gradient-to-br from-indigo-600 to-violet-700 p-5 rounded-2xl text-white shadow-lg overflow-hidden relative group">
